...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateTotal() {
        ...
        if (totalEl) totalEl.textContent = calculateTotal() + ' FC';
    }
    ...
    function saveCart() {
        ...
        axios
            .post(saveUrl, { products: cart.products })
            .then(() => {
